...
USB$DATAPORT	EQU	035H		;Data port for the DLP Controller
USB$STATUS$PORT	EQU	034H		;Status port for DLP Controller (Port C of 8255)
USB$RXE		EQU	01H		;If bit 7 = 0, data available
USB$TXE		EQU	02H		;If Bit 6 = 0, data can be written to chip for transmission
