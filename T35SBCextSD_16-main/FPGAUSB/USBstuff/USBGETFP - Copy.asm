...
USB$DATAPORT	EQU	035H		;Data port for Z80 FPGA SBC board
USB$STATUS$PORT	EQU	034H		;Status port for Z80 FPGA SBC USB board
;USB$RXE		EQU	01H				;If bit 0 = 0, data available
USB$RXE		EQU	04H				;If bit 2 = 1, data available
...
SIGNON:	DB	'Get a File from a PC using the '
	DB	'S100Computers Z80 FPGA SBC Board USB Port.',13,10
	DB	'USB Status on USB Port 34H, Data on USB Port 35H.',13,10,10,'$'
